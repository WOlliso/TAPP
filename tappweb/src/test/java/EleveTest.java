...
public class EleveTest {
	...
	public void init() throws SQLException {
		...
		final String reqtable = "CREATE TABLE eleves (id_eleves serial NOT NULL,  prenom character varying, nom character varying, classe character varying, CONSTRAINT primary_eleves PRIMARY KEY (id_eleves))";
	...
	//
	// @Test
	// // Test de la modification de l'éléve dans la base en comptant le nombre
	// de
	// // lignes de la base
	...
	// //String request =
	// "SELECT id_eleves , nom, prenom, classe FROM eleves WHERE nom ='"
	...
	public void end() throws SQLException {
		final String sql2 = "DROP TABLE public.eleves;";
