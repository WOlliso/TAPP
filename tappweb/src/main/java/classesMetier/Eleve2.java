...
public class Eleve2 {
	...
	public Eleve2(String nom, String prenom, int age, Classe classe) {
		super();
		this.nom = nom;
		this.prenom = prenom;
		this.age = age;
	...
	public Eleve2 insertEleve(String nom, String prenom, int age, Classe classe) throws SQLException{
		...
		return  new Eleve2(nom,prenom, age,classe);
	}


	public List<Eleve2> selectEleves(){
		return null;
	}
	public Eleve2 selectEleveParNom(){

		return null;
	}

	public Eleve2 selectEleveParClasse(){
		return null;
	}
